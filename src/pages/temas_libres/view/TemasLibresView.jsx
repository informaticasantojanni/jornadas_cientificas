      ...
      <section className="mt-3 rounded-tl-xl bg-White flex flex-col items-center px-3 py-10 laptop1:ms-40">
        <div className="w-[350px] tablet:w-[700px] laptop1:w-[800px] flex flex-wrap items-center justify-between gap-3 mb-5">
          ...
          <div className="flex items-center gap-1 bg-DarkGrey rounded-full p-1">
            <button type="button" onClick={() => setTemasLibresView(VISTAS_TEMAS_LIBRES.PRESENTAR_TRABAJOS)} className={`text-sm font-semiBol px-4 py-1.5 rounded-full transition duration-300 ease-in-out ${temasLibresView === VISTAS_TEMAS_LIBRES.PRESENTAR_TRABAJOS ? "bg-LightViolet text-White shadow" : "text-Violet hover:bg-White"}`}>
              Presentar Trabajos
            </button>
            <button type="button" onClick={() => setTemasLibresView(VISTAS_TEMAS_LIBRES.GESTIONAR_TRABAJOS)} className={`text-sm font-semiBol px-4 py-1.5 rounded-full transition duration-300 ease-in-out ${temasLibresView === VISTAS_TEMAS_LIBRES.GESTIONAR_TRABAJOS ? "bg-LightViolet text-White shadow" : "text-Violet hover:bg-White"}`}>
              Gestionar Trabajos
            </button>
          </div>
        </div>
