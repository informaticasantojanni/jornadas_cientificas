...
export const useTemasLibres = () => {
  ...
  useEffect(() => {
    const filterTemasLibres = () => {
      console.log(filtrarTrabajos);
      const filtered = listaTemasLibres.filter(
        (tema) =>
          tema.titulo
            .toLowerCase()
            .includes(filtrarTrabajos.query.toLowerCase()) ||
          (Array.isArray(tema.autoresList) &&
            tema.autoresList.some((autor) =>
              autor.toLowerCase().includes(filtrarTrabajos.query.toLowerCase())
            )) ||
          ...
          tema.contactoNombre
            .toLowerCase()
            .includes(filtrarTrabajos.query.toLowerCase()) ||
          tema.contactoApellido
            .toLowerCase()
            .includes(filtrarTrabajos.query.toLowerCase()) ||
          tema.contactoEmail
            .toLowerCase()
            .includes(filtrarTrabajos.query.toLowerCase()) ||
          tema.contactoCelular
            .toLowerCase()
            .includes(filtrarTrabajos.query.toLowerCase())
      );
